...
fn test_skip_i64_max() {
    ...
    /*
     * Some platforms do not allow seek on i64::MAX offset.
     * The test is meaningless so just skip it
     */
    let Some(_) = at.seek("tempfile", 9_223_372_036_854_775_807).ok() else {
        return;
    };
